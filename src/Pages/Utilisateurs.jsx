      ...
      <form autoComplete="off" onSubmit={editMode ? handleUpdate : handleAddUser} style={{ marginBottom: 20 }}>
        ...
        <FormControl style={{ marginRight: 10 }}>
          ...
          <RadioGroup
            ...
            onChange={handleChange}
          >
            <FormControlLabel value="ADMIN_USER" control={<Radio />} label="Admin-user" />
          ...
          <TableBody>
            {utilisateurs.map((user) => (
              <TableRow key={user.matricule}>
                ...
                <TableCell>
                  <Button onClick={() => handleEdit(user)} variant="outlined" color="primary">Éditer</Button>
                  <Button onClick={() => confirmDelete(user.matricule)} variant="outlined" color="secondary" style={{ marginLeft: 10 }}>Supprimer</Button>
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
